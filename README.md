...
2. El siguiente paso consiste en separar la lógica de negocio y la de presentación, siguiendo los principios de separación de capas. Actualmente, toda esta lógica se encuentra "mezclada" en una sola capa, en el archivo `handlers/metrics.ts`.
